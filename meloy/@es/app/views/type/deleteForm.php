...
<form class="ui form" data-tea-action=".delete" data-tea-confirm="确定要删除当前类型吗？所有数据都会丢失！" data-tea-timeout="3600" data-tea-before="beforeDelete()" ng-show="supportsDelete">
